...
namespace SerializationAndDeserialization
{
    public class BinarySerialization
    {
        public void Serialization()
        {
            ...
            FileStream fileStream = new FileStream(@"C:\Users\navee\OneDrive\Documents\Bridgelabz practice\SerializationAndDeserialization\SerializationAndDeserialization\Files\Example.txt", FileMode.Create);
        ...
        {
            FileStream fileStream = new FileStream(@"C:\Users\navee\OneDrive\Documents\Bridgelabz practice\SerializationAndDeserialization\SerializationAndDeserialization\Files\Example.txt", FileMode.Open);
            BinaryFormatter formatter = new BinaryFormatter();
